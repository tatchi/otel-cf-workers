...
export declare function sanitiseURL(url: string): string;
...
export declare function instrumentFetcher(fetchFn: Fetcher['fetch'], configFn: getFetchConfig, attrs?: Attributes): Fetcher['fetch'];
