...
exports.instrumentDOClass = exports.executeDOAlarm = exports.executeDOFetch = exports.instrumentState = exports.instrumentDOBinding = void 0;
    ...
    const stubHandler = {
        get(target, prop) {
            if (prop === 'fetch') {
                ...
                return (0, fetch_js_1.instrumentFetcher)(fetcher, () => ({ includeTraceContext: true }), attrs);
            }
            else {
...
function executeDOFetch(fetchFn, request, id) {
    ...
    const name = id.name || '';
    const promise = tracer.startActiveSpan(`do.fetchHandler:${name}`, options, spanContext, (span) => __awaiter(this, void 0, void 0, function* () {
        try {
...
function executeDOAlarm(alarmFn, id) {
    ...
    const name = id.name || '';
    const promise = tracer.startActiveSpan(`do.alarmHandler:${name}`, (span) => __awaiter(this, void 0, void 0, function* () {
