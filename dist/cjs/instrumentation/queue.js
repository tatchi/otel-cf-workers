...
exports.instrumentQueueSender = exports.createQueueHandler = exports.executeQueueHandler = void 0;
...
function executeQueueHandler(queueFn, [batch, env, ctx]) {
    ...
    const promise = tracer.startActiveSpan(`queueHandler:${batch.queue}`, options, (span) => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            yield span.setAttribute('queue.implicitly_acked', count.total - count.succeeded - count.failed);
            count.ackRemaining();
...
function instrumentQueueSend(fn, name) {
    ...
    const handler = {
        apply: (target, thisArg, argArray) => {
            return tracer.startActiveSpan(`queueSend: ${name}`, (span) => __awaiter(this, void 0, void 0, function* () {
...
function instrumentQueueSendBatch(fn, name) {
    ...
    const handler = {
        apply: (target, thisArg, argArray) => {
            return tracer.startActiveSpan(`queueSendBatch: ${name}`, (span) => __awaiter(this, void 0, void 0, function* () {
